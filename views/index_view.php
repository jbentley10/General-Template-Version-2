...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Fredoka+One|Grand+Hotel|Merienda+One|Scada|The+Girl+Next+Door" rel="stylesheet">
...
<body class="compliment">
    ...
    <header class="index-header">
        ...
        <div class="form_bg col-xl-10 col-sm-12 col-md-12 col-xl-offset-1 animated fadeIn">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="btn-container">
                <a href="#" onclick="clickOrderNow();"><button class="btn" id='kformSubmit' type="submit">Order Now</button></a>
            </div>
          </div>
          <div class="col-md-6">
            <img class="animated fadeInDown" alt="Muscle Enhance Logo" src="../img/logo.png" />
